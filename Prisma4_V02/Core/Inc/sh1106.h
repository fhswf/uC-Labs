...
#define SH1106_RST_PORT      DISP_RST_GPIO_Port
#define SH1106_RST_PIN       DISP_RST_Pin
...
// SH1106 CS (Chip Select) pin (PC9)
#define SH1106_CS_PORT       DISP_CS_GPIO_Port
#define SH1106_CS_PIN        DISP_CS_Pin
