...
int main(void)
{
  ...
  /* Copy of above init code with additional check if USB connected */
  MX_GPIO_Init();
  if (HAL_GPIO_ReadPin(USB_PWRD_GPIO_Port, USB_PWRD_Pin) == 1)  // USB Cable is connected
  {
	  MX_USB_Device_Init();
  }
  MX_I2C1_Init();
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, DISP_CS_Pin|BMI08_INT1_Pin|BMI08_INT3_Pin|DISP_ON_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(BT_PWRN_GPIO_Port, BT_PWRN_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : DISP_CS_Pin BMI08_INT1_Pin BMI08_INT3_Pin DISP_ON_Pin */
  GPIO_InitStruct.Pin = DISP_CS_Pin|BMI08_INT1_Pin|BMI08_INT3_Pin|DISP_ON_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : BT_KEY_Pin DISP_RST_Pin NSLEEP_Pin LED2_Pin
                           LED1_Pin */
  GPIO_InitStruct.Pin = BT_KEY_Pin|DISP_RST_Pin|NSLEEP_Pin|LED2_Pin
                          |LED1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : BT_PWRN_Pin */
  GPIO_InitStruct.Pin = BT_PWRN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(BT_PWRN_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : MOT_PGOOD_Pin NFAULT_Pin */
  GPIO_InitStruct.Pin = MOT_PGOOD_Pin|NFAULT_Pin;
